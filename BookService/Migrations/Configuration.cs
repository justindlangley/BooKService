    ...
    internal sealed class Configuration : DbMigrationsConfiguration<BookService.Models.BookServiceContext>
    {
        ...
        protected override void Seed(BookService.Models.BookServiceContext context)
        {
            ...
            context.Books.AddOrUpdate(x => x.Id,
                ...
                new Book() { Id = 3, Title = "David Copperfield", Year = 1850, AuthorId = 2, Price = 2, Genre = "Bildungroman" },
                new Book() { Id = 4, Title = "Don Quixote", Year = 1617, AuthorId = 3, Price = 8.95M, Genre = "Picarsque" }
                );
        }
    }
}
